...
function not_argv_enough ($type) {
    ...
    echo "\033[40m\033[1;37mtapez\033[1;31m ./" . $GLOBALS["filename"] . " \033[1;32m" . $type . "\033[40m\033[1;37m pour avoir l'aide pour utiliser le script avec mysql\033[0m\n";
}
...
if (count($argv) === 1) {
    ...
    echo "\033[1;31m./" . $GLOBALS["filename"] . " \033[1;32mmysql\033[40m\033[1;37m pour avoir l'aide pour utiliser le script avec mysql\033[0m\n";
} elseif ($argv[1] === "liste") {
    ...
    if (count($argv) === 2) {
        ...
        echo "\033[1;31m./" . $GLOBALS["filename"] . " \033[1;32mmysql [host] [username] [password] [database]\n";
        echo "\033[1;31mtapez \033[1;32mdebug\033[1;31m avant \033[1;32mmysql \033[1;37m pour avoir les erreurs originelle\n";
        echo "\033[1;32m[type]\033[1;37m     => le type de base de donnée (ici mysql) \033[1;31mArgument obligatoire\n";
        echo "\033[1;32m[host]\033[1;37m     => le serveur (localhost si vous êtes en dev) \033[1;31mArgument obligatoire\n";
        echo "\033[1;32m[username]\033[1;37m => le nom d'utilisateur pour ce connecter à votre mysql \033[1;31mArgument obligatoire\n";
        echo "\033[1;32m[password]\033[1;37m => le mot de passe pour ce connecter à votre mysql \033[1;31mecrire [] si vous avez un mot de passe vide !! \033[1;31mArgument obligatoire\n";
